...
//        	System.out.println("博客标题： "+element.text());
        	System.out.println("博客标题： "+element.attr("href"));
        }
        
        Element elementLink=doc.select("#friend_link").first();
        
        System.out.println("文本+html： "+elementLink);
    	System.out.println("文本： "+elementLink.text());
    	System.out.println("html： "+elementLink.html());
